...
const ContactForm = ({ 
  ...
  return (
    <motion.div
      {...fadeInUp}
      className={`card p-4 sm:p-6 md:p-8 ${className}`}
    >
      {!compact && (
        <div className="text-center mb-6 sm:mb-8">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-heading font-bold text-surface-900 mb-2">
            {title}
          </h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`form-input text-sm sm:text-base ${errors.name ? 'border-error' : ''}`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`form-input text-sm sm:text-base ${errors.phone ? 'border-error' : ''}`}
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`form-select ${errors.workType ? 'border-error' : ''}`}
          >
          ...
          {errors.workType && (
            <p className="text-error text-sm mt-1">{errors.workType}</p>
          )}
        </div>
        ...
        <div className="flex items-start gap-3">
          <input
            ...
            onChange={handleChange}
            className="mt-1 w-4 h-4 text-brand-primary border-surface-300 rounded focus:ring-brand-primary"
          />
          <label className="text-sm text-surface-600">
            I agree to be contacted by EasiHome regarding my inquiry. 
